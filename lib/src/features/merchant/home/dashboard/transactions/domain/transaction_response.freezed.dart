...
class _$TransactionResponseImpl implements _TransactionResponse {
  _$TransactionResponseImpl(
      {@JsonKey(name: 'idDeal') this.idDeal,
      this.code,
      this.total,
      this.marchand,
      this.trid,
      ...
      this.date,
      this.time,
      @JsonKey(name: 'idOperator') this.idOperator,
      this.quoteId});
  ...
  @override
  String toString() {
    return 'TransactionResponse(idDeal: $idDeal, code: $code, total: $total, marchand: $marchand, trid: $trid, status: $status, date: $date, time: $time, idOperator: $idOperator, quoteId: $quoteId)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, idDeal, code, total, marchand,
      trid, status, date, time, idOperator, quoteId);
...
abstract class _TransactionResponse implements TransactionResponse {
  factory _TransactionResponse(
      {@JsonKey(name: 'idDeal') final int? idDeal,
      final String? code,
      final double? total,
      final String? marchand,
      final String? trid,
      ...
      final String? date,
      final String? time,
      @JsonKey(name: 'idOperator') final String? idOperator,
