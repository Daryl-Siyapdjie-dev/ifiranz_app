...
class CreateMerchandAddScreen extends StatefulHookConsumerWidget {
  ...
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _CreateMerchandAddScreenState();
}

class _CreateMerchandAddScreenState extends ConsumerState<CreateMerchandAddScreen> {
    ...
    ref.listen(
      ...
      (previous, next) {
        next.maybeMap(
            ...
            data: (res) {
              ref.read(merchandClientsNotifierProvider.notifier).createClient(res.value);

              showSuccessFlushbar(context, context.locale.merchandAddCientScreenAddSucces);
            });
      },
    );
                  ...
                  child: Form(
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
                      ...
                      CommonTextFormField(
                        ...
                        validator: (value) => ref.read(formValidationServiceProvider).validateSimple(value),
                      ),
                      gapH20,
                      CommonTextFormField(
                        ...
                        hintText: 'Email',
                        label: 'Email',
                        validator: (value) => ref.read(formValidationServiceProvider).validateEmail(value),
                      ),
                      gapH20,
                      CommonTextFormField(
                      ...
                      CommonTextFormField(
                        ...
                        hintText: context.locale.registerAdditionnalAddressDistrict,
                        validator: (value) => ref.read(formValidationServiceProvider).validateSimple(value),
                      ),
                      gapH20,
                      CommonTextFormField(
                        ...
                        isLabelRequired: true,
                        hasLabel: true,
                        hintText: context.locale.registerAdditionnalLocationNeighborhood,
                      ...
                      ElevatedButton(
                        onPressed: () => _registerAdditionalInfo(
                            ...
                            AddClientRequest(
                                ...
                                phoneNumber: _phoneCode.replaceAll('+', '00') + phoneNumberController.text.trim().removeAllSpace(),
                                localisationGps: localisationGpsController.text.trim(),
  ...
  void _registerAdditionalInfo(BuildContext context, AddClientRequest request) {
    ...
    ref.read(additionalInfoNotifierProvider.notifier).registerUserAdditionalInfo(request: request).then((value) {}).whenComplete(() {
      progress!.dismiss();
    });
  }
}
