                        ...
                        child: Column(
                          children: [
                            ...
                            Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              ...
                              allQuartier.maybeWhen(
                                ...
                                error: (e, s) => IconButton(
                                    onPressed: () => ref.read(findQuartierPoductsProvider.notifier).findProductQuartier(),
                            ...
                            CommonTextFormField(
                              ...
                              autovalidateMode: AutovalidateMode.onUserInteraction,
                              hintText: context.locale.createNewColisScreenDueAmount,
                              textInputAction: TextInputAction.done,
                              textInputType: TextInputType.text,
                              isLabelRequired: true,
                              hasLabel: true,
                              validator: ref.read(formValidationServiceProvider).validateNumber,
                              label: context.locale.createNewColisScreenDueAmount,
                              obscureText: false,
                            ),
                            gapH20,
                            CommonTextFormField(
