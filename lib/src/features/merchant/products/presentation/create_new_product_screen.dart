...
class CreateNewProductScreen extends StatefulHookConsumerWidget {
  ...
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _CreateNewProductScreenState();
}

class _CreateNewProductScreenState
                        ...
                        children: [
                          Container(
                            ...
                            child: image.value is File
                                ...
                                : SvgPicture.asset(
                                    'assets/images/line-md_image.svg'),
                          ),
                          gapW25,
                          SizedBox(
                            width: 27,
                                ...
                                children: [
                                  ...
                                  types.maybeWhen(
                                      ...
                                      error: (e, s) => IconButton(
                                          onPressed: () =>
                                              ref.read(merchandTypesNotifierProvider.notifier).getAllTypes(
                                                  params),
