...
class ClientDeliveryScreen extends StatefulHookConsumerWidget {
  ...
  const ClientDeliveryScreen(
      {super.key, required this.data, this.isMerchant = false});
...
class _ClientDeliveryScreenState extends ConsumerState<ClientDeliveryScreen> {
  ...
  void handleUpadteStatus(OrderStatus status) {
    setState(() {
      data = data.copyWith(
          commande: data.commande?.copyWith(statut: status.value));
    });
  }
                    ...
                    child: Column(
                        ...
                        children: [
                          if (widget.data.otp is String)
                            Text(
                              context.locale
                                  .deliveryCodeIs(widget.data.otp ?? ""),
                          ...
                          Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                Expanded(
                                    child: Divider(
                                  color: stepOrderValidator(widget.data.statut!,
                          ...
                          ListTile(
                            leading: SizedBox(
                              ...
                              child: ClipRRect(
                                  ...
                                  child: CachedNetworkImage(
                                    imageUrl: widget.data.livreur?.url ??
                            ...
                            subtitle: Text(
                                '${widget.data.livreur?.nom ?? ""} ${widget.data.livreur?.prenom ?? ""}',
                          ...
                          ElevatedButton.icon(
                            style: ElevatedButton.styleFrom(
                                ...
                                backgroundColor:
                                    widget.data.livreur?.telephone1 == null
                                        ? AppColors.greyLight
                            ...
                            label: Text(
                                widget.data.livreur?.telephone1 ?? "+237XXXXX"),
                          ...
                          ElevatedButton.icon(
                            style: ElevatedButton.styleFrom(
                                padding:
                                    const EdgeInsets.symmetric(vertical: 12),
                                backgroundColor:
                                    widget.data.livreur?.telephone2 == null
                                        ? AppColors.greyLight
                                        : AppColors.secondaryColor),
                            icon: const Icon(
                              Icons.phone,
                            ...
                            label: Text(
                                widget.data.livreur?.telephone2 ?? "+237XXXXX"),
