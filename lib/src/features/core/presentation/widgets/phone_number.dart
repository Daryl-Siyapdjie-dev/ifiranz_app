...
import '../../infrastructure/extensions/localization_extension.dart';
import '../../infrastructure/extensions/theme_extension.dart';
...
class StreamError {
  ...
  Future get dispose => historiyController.close();
}
